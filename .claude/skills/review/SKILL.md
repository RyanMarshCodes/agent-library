...
1. Use the Read tool to read `D:/Projects/agent-configurations/ai-docs/agents/code-analysis.agent.md` — apply the quality assessment lens from that agent
2. Use the Read tool to read `D:/Projects/agent-configurations/ai-docs/agents/security-check.agent.md` — apply the security checks from that agent
3. Use the Read tool to read `D:/Projects/agent-configurations/ai-docs/agents/code-simplifier.agent.md` — apply the simplification lens from that agent
