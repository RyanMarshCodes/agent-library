...
Use the Read tool to read `D:/Projects/agent-configurations/ai-docs/agents/tech-debt-analysis.agent.md` then follow the workflow defined in that file exactly.
