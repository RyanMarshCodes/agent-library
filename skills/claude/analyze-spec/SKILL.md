...
Use the Read tool to read `D:/Projects/agent-configurations/agents/openapi-client-builder.agent.md` then follow the workflow defined in that file exactly.
