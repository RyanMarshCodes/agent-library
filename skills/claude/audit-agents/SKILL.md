...
Use the Read tool to read `D:/Projects/agent-configurations/agents/ai-agent-expert.agent.md` then follow the auditing workflow defined in that file.

Agent library path: `D:/Projects/agent-configurations/agents/`

All agent files to audit: !`ls D:/Projects/agent-configurations/agents/`
Catalog: !`cat D:/Projects/agent-configurations/catalog.json`
...
Write the audit report to `D:/Projects/agent-configurations/docs/agent-audit-{date}.md` where {date} is today's date in YYYY-MM-DD format.
