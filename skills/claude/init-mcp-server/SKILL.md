...
Use the Read tool to read `D:/Projects/agent-configurations/agents/csharp-mcp-expert.agent.md` then follow the expertise defined in that file.
...
3. In `appsettings.json`, set:
   ...
   - `McpOptions.Agents.LibraryPath` → relative path to the agent library (`../../../agents` for repos using this config repo structure, or ask the user)
